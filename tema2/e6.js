...
/*  El  cálculo  de  la  letra  del  Documento  Nacional  de  Identidad  (DNI) 
    es  un  proceso matemático sencillo que se basa en obtener el resto de la división entera
    del número de DNI y el número 23. A partir del resto de la división, se obtiene la letra 
    seleccionándola dentro de un array de letras. El array de letras es:  
    ...
    la letra es la A. Con estos datos, elaborar un pequeño script que:-Almacene en una variable 
    el número de DNI indicado por el usuario y en otra variable la letra del DNI que se ha indicado.

    -En  primer  lugar  se  debe  comprobar  si  el  número  es  menor  que  0  o  mayor  que 
    ...
    por el usuario. Si no coinciden, se muestra un mensaje al usuario diciéndole que la 
    ...
    if(!isNaN(n) && n>0 && n<=99999999 ) {
        ...
        letras[n%23]==l.toUpperCase() ? alert("Su DNI y letra son correctos")  : alert("Letra incorrecta");

    } else {
        alert ("Por favor, introduzca un número de dni valido");
    }
